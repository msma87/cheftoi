...
services = [
  {
    ...
    service1.photo.attach(io: URI.open(service1_url), content_type: "image/png", filename: service1.name)
  }
  {
    ...
    service2.photo.attach(io: URI.open(service2_url), content_type: "image/png", filename: service2.name)
  },
  {
    ...
    service3.photo.attach(io: URI.open(service3_url), content_type: "image/png", filename: service3.name)
  },
  {
    ...
    service4.photo.attach(io: URI.open(service4_url), content_type: "image/png", filename: service4.name)
  },
  {
    ...
    service5.photo.attach(io: URI.open(service5_url), content_type: "image/png", filename: service5.name)
  },
  {
    ...
    service6.photo.attach(io: URI.open(service6_url), content_type: "image/png", filename: service6.name)
  }
  {
    ...
    service7.photo.attach(io: URI.open(service7_url), content_type: "image/png", filename: service7.name)
  },
  {
    ...
    service8.photo.attach(io: URI.open(service8_url), content_type: "image/png", filename: service8.name)
  }
  {
    ...
    service9.photo.attach(io: URI.open(service9_url), content_type: "image/png", filename: service9.name)
  },
  {
    ...
    service10.photo.attach(io: URI.open(service10_url), content_type: "image/png", filename: service10.name)
  },
 


  service2 = Service.create!(title: "Rodízio de Sushi", category: "Japonesa", price: 750.00, description: "Rodízio de sushi fresco e servido em casa", user: user_records[1])
  service2_url = "https://res.cloudinary.com/dq3bwy9sm/image/upload/v1732821676/Sushis_s8s5tf.jpg"
  service2.photo.attach(io: URI.open(service2_url), content_type: "image/png", filename: service2.name)
