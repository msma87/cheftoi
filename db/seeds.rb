...
services_data = [
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334696/jantar-romantico_n5fftm_esuqlc.jpg",
    user: users[0]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334710/Vegan-Easter-Buffet_gvqqvl_bh99ct.jpg",
    user: users[1]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334727/pasta-beef-restaurant-gourmet-flavor-italian-specialties-ambiance-chefs-dishes-quality_1246444-74550_f6q7l5_lr5qpf.jpg",
    user: users[2]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334778/d3bd6c16a48f5918745252708c3634d1_lq0kby_nyefox.jpg",
    user: users[0]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334802/gastronomia-enjoy-blog-1024x682_p8zoah_coequl.jpg",
    user: users[1]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334825/rodizios-min-1_nd9kas_enyhkp.jpg",
    user: users[1]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334846/3.-Paella-Valenciana_wakksd_gdrygv.jpg",
    user: users[2]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334856/feijoada-wooden-table-traditional-brazilian-food_123827-26007_nswexr_r9du4j.jpg",
    user: users[2]
  },
  {
    ...
    photo_url: "https://res.cloudinary.com/ddbg7qknd/image/upload/v1745334865/yukiko-kanada-Ou4CQo6jzvU-unsplash-1024x692_owwyaf_lgzhcu.jpg",
    user: users[1]
  }
]
